const Modal = ({ painting, toggleModal }) => {
  return (
    <div className='fixed top-0 z-50 flex h-screen w-full flex-col items-center bg-black/[0.8539] pt-[9.063rem]'>
      <div className='flex w-[87.2%] flex-col items-end gap-8'>
        <button
